...
export default function GastosPage() {
  ...
  const {
    ...
    updateExpense,
    deleteExpense,
    getTotalByCategory: _getTotalByCategory,
    getTransactionsByCategory: _getTransactionsByCategory,
  } = useMonthlyExpenses();

  // Estados locales
  const [selectedOption, setSelectedOption] = useState<
    'manual' | 'factura' | 'cufe' | null
  >(null);
      ...
      <div className="max-w-5xl mx-auto space-y-8">
                  ...
                  {migrationStatus.hasJulyData ? (
                    <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
                      <p className="text-green-400">
                        ✅ Ya tienes {migrationStatus.expenseCount} gastos en
                        julio 2025
                      </p>
                    ...
                    <div className="space-y-4">
                      <p className="text-slate-300">
                        No tienes gastos registrados para julio 2025. ¿Quieres
                        migrar los datos de ejemplo?
                      </p>
        ...
        {expenseData && !loading && (
          <Card variant="glass" className="p-6">
            <CardHeader>
              <CardTitle>
                Transacciones de {formatMonthName(selectedMonth)}
              </CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Dialog
          open={isModalOpen}
          onOpenChange={isModalOpen ? handleCloseModal : openModal}
        >
          ...
          <DialogContent className="sm:max-w-[600px] bg-slate-800 border-slate-700">
            <DialogHeader>
              ...
              <DialogDescription className="text-slate-400">
                {selectedOption === null
                  ? 'Selecciona cómo quieres agregar tu gasto'
                  : selectedOption === 'manual'
              ...
              <div className="grid grid-cols-1 gap-4 py-4">
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-slate-400 text-sm">
                      Toma foto de la factura para extraer datos
                    </p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-slate-400 text-sm">
                      Escanea el código QR de factura electrónica
                    </p>
                  </div>
                </button>
              </div>
